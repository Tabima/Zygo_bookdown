...
### Observing predation of _C. elegans_ by _Stylopage_ _hadra_ in mixed culture
...
```{r ch3fig1, echo=FALSE, fig.align='center', fig.width = 12, fig.cap= "Line drawings adapted from @Drechsler_1935B and @Drechsler_1937)that depict the conidial and conidiophore morphology of two genera of nematode-trapping ascomycetes (left and center) in comparison to _Stylopage hadra_ (right). Notice the grouping of uniseptate conidia in _Arthrobotrys _into large clusters. Also note the absence of internal septa in the conidia on _S. hadra_."}

knitr::include_graphics("img/Ch3_Fig1.png", dpi = 75)
```
...
```{r ch3fig2, echo=FALSE, fig.align='center', fig.width = 6, fig.cap= "Line drawing of the life cycle of _Stylopage hadra_ by George Barron (http:/hdl.handle.net/10214/5530). A. Aerial spores on conidiophores. B, C. Captured nematodes in different stages of digestion."}

knitr::include_graphics("img/Ch3_Fig2.jpg", dpi = 75)
```
...
```{r ch3fig3, echo=FALSE, fig.align='center', fig.width = 6, fig.cap= "Line drawings of _Acaulopage tetraceros_ illustrating the distinctive conidia and a captured amoeba, by George Barron. (http://hdl.handle.net/10214/5456)."}

knitr::include_graphics("img/Ch3_Fig3.jpg", dpi = 75)
```
...
```{r ch3fig4, echo=FALSE, fig.align='center', fig.width = 6, fig.cap= "Phase contrast micrograph of _Zoophagus insidians_ by George Barron (http://hdl.handle.net/10214/5598)."}

knitr::include_graphics("img/Ch3_Fig4.jpg", dpi = 75)
```
...
```{r ch3fig5, echo=FALSE, fig.align='center', fig.width = 6, fig.cap= "Line drawings of chlamydospores of _Cystopage ovispora_ based on Ho et al. (2015). Chlamydospores can be borne on a short lateral branch (left), directly on the hyphae (center), or intercalary (right)."}

knitr::include_graphics("img/Ch3_Fig5.png", dpi = 75)
```
...
```{r ch3fig6, echo=FALSE, fig.align='center', fig.width = 6, fig.cap= "Line drawing of _Rhopalomyces elegans_ by George Barron (http://hdl.handle.net/10214/6251) depicting aerial sporangiophores (left), predation on a nematode egg (top right), and different stages of adult nematode predation (middle and bottom right)."}

knitr::include_graphics("img/Ch3_Fig6.jpg", dpi = 75)
```
...
```{r ch3fig7, echo=FALSE, fig.align='center', fig.width = 6, fig.cap= "Modified line drawing of figure 2 from Degawa (2014) depicting a sporangiophore with a dark spore mass (right) and a captured nematode (left)."}

knitr::include_graphics("img/Ch3_Fig7.png", dpi = 75)
```
...
```{r ch3fig8, echo=FALSE, fig.align='center', fig.width = 6, fig.cap= "Light micrograph of _Helicocephalum oligosporum_ depicting a young sporangiophore by George Barron (http://hdl.handle.net/10214/5481)."}

knitr::include_graphics("img/Ch3_Fig8.jpg", dpi = 75)
```
...
```{r ch3fig9, echo=FALSE, fig.align='center', fig.width = 6, fig.cap= "Line drawings of _Brachymyces megasporus_ by George Barron (http://hdl.handle.net/10214/6171)."}

knitr::include_graphics("img/Ch3_Fig9.jpg", dpi = 75)
```
